...
- All 36 Playwright tests pass against the production build. Journeys cover search, preserved activity state, stop access, guided recovery, midpoint rating selection, color edits, sandtray undo/retry/exit, resources and selective printing.
